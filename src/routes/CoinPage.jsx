    ...
    <div className='rounded-div my-12 py-8'>
      <div className='flex py-8'>
        ...
        <div>
          ...
          <p>({coin.symbol?.toLocaleUpperCase()} / USD)</p>
        </div>
      </div>
      ...
      {/* Description */}
      <div className='py-4'>
        <p className='text-xl font-bold text'>About {coin.name}</p>
        <p className='text-justify' dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(coin.description ? coin.description.en : '')}}></p>
      </div>
    </div>
  )
}
